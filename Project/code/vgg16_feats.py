...
if args.type == "SEEN":
	...
	TRAIN_FEAT_FILE = "train_vgg16_feats_SEEN.pkl"
	TEST_FEAT_FILE = "test_vgg16_feats_SEEN.pkl"
	FEAT_LABEL = "feats"
else:
	TRAIN_DATA_DIR = "train_anno/"
	TEST_DATA_DIR = "test_anno/"
	TRAIN_FEAT_FILE = "test_anno_with_vgg16_face_feats.pkl"
	TEST_FEAT_FILE = "train_anno_with_vgg16_face_feats.pkl"
	FEAT_LABEL = "vgg16_feats"
...
class PREVGG(nn.Module):
	...
	def forward(self,input):
		feats = self.vgg16.features(input.permute(0,3,1,2))
...
# runs 2 times for train and test data
for i in range(len(DATA_FILES)):
	...
	data_with_feats["feats"] = data_feats
