...
if args.type == "SEEN":
	...
	TRAIN_FEAT_FILE = "train_resnet18_feats_SEEN.pkl"
	TEST_FEAT_FILE = "test_resnet18_feats_SEEN.pkl"
	FEAT_LABEL = "feats"
else:
	TRAIN_DATA_DIR = "train_anno/"
	TEST_DATA_DIR = "test_anno/"
	TRAIN_FEAT_FILE = "train_anno_with_resnet18_feats.pkl"
	TEST_FEAT_FILE = "test_anno_with_resnet18_feats.pkl"
