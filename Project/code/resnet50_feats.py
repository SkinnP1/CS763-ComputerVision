...
if args.type == "SEEN":
	...
	TRAIN_FEAT_FILE = "train_resnet50_feats_SEEN.pkl"
	TEST_FEAT_FILE = "test_resnet50_feats_SEEN.pkl"
	FEAT_LABEL = "feats"
else:
	TRAIN_DATA_DIR = "train_anno/"
	TEST_DATA_DIR = "test_anno/"
	TRAIN_FEAT_FILE = "train_anno_with_resnet50_feats.pkl"
	TEST_FEAT_FILE = "test_anno_with_resnet50_feats.pkl"
...
class PREResNet(nn.Module):
	def __init__(self):
		super().__init__()
		# permute used because resnet accepts 3,H,W input shape
